...
export const venuesData: Venue[] = [
  {
    id: '123e4567-e89b-12d3-a456-426614174000', // Changed to UUID format
    name: 'Luna',
    image:
  ...
  {
    id: '223e4567-e89b-12d3-a456-426614174001', // Changed to UUID format
    name: 'Rosa',
    image:
  ...
  {
    id: '323e4567-e89b-12d3-a456-426614174002', // Changed to UUID format
    name: 'Aura',
    image:
  ...
  {
    id: '423e4567-e89b-12d3-a456-426614174003', // Changed to UUID format
    name: 'Mini Max',
    image:
